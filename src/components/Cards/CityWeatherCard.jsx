...
const kilometersHour = Math.round((cityWeather?.wind.speed * 3600)/1000)
  ...
  return (
   ...
   icon={cityWeather?.rain? <FontAwesomeIcon icon={faUmbrella} className="secondary-icon"/> : <FontAwesomeIcon icon={faWind} className="secondary-icon"/>}  
   value={cityWeather?.rain? `${cityWeather?.rain?.["1h"]} mm última h` : `${cityWeather?.wind.deg}°`}
   />
...
<Circle id="circle-five" 
   ...
   icon={cityWeather?.snow? <FontAwesomeIcon icon={faSnowflake} className="secondary-icon"/> : <FontAwesomeIcon icon={faCloud} className="secondary-icon"/>}  
